...
pub fn course_builder() -> CourseBuilder {
    let earmaster_course = EarMasterCourse {
        ...
        lessons: vec![
            ...
            EarMasterLesson::new("3.1", "Do, Re - 7 tones", vec!["2.7"]),
            EarMasterLesson::new("3.2", "Do, Re, Mi", vec!["3.1"]),
            EarMasterLesson::new("3.3", "Do, Re, Mi, Fa", vec!["3.2"]),
            EarMasterLesson::new("3.4", "Do, Re, Mi, Fa, So", vec!["3.3"]),
            EarMasterLesson::new("3.5", "Do, Re, Mi, Fa, So, La", vec!["3.4"]),
            EarMasterLesson::new("3.6", "Do, Re, Mi, Fa, So, La, Ti", vec!["3.5"]),
            EarMasterLesson::new("3.7", "Do, Re - 8 tones", vec!["3.1"]),
            EarMasterLesson::new("3.8", "Do, Re, Mi", vec!["3.7"]),
            EarMasterLesson::new("3.9", "Do, Re, Mi, Fa", vec!["3.8"]),
            EarMasterLesson::new("3.10", "Do, Re, Mi, Fa, So", vec!["3.9"]),
            EarMasterLesson::new("3.11", "Do, Re, Mi, Fa, So, La", vec!["3.10"]),
            EarMasterLesson::new("3.12", "Do, Re, Mi, Fa, So, La, Ti", vec!["3.11"]),
